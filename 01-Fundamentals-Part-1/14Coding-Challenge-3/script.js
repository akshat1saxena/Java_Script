...
// for each team, using the test data below

// 2. Compare the team 's average scores to determine the winner of the competition, and print it to the console.
// Don 't forget that there can be a draw, so test
// for that as well(draw means they have the same average score)

// 3. Bonus 1: Include a requirement
// for a minimum score of 100. With this rule, a team only wins
// if it has a higher score than the other team, and the same time a score of at least 100 points.
// Hint: Use a logical operator to test
// for minimum score, as well as multiple
// else -
//     if blocks
...
//     §§§
//     Data:
//     1: Dolphins score 96, 108 and 89. Koalas score 88, 91 and 110 Data Bonus
// 2: Dolphins score 97, 112 and 101. Koalas score 109, 95 and 123 Data Bonus
// 3: Dolphins score 97, 112 and 101. Koalas score 109, 95 and 106.

const dolphinsAverageScore1 = (96 + 108 + 89) / 3;
const koalasAverageScore1 = (88 + 91 + 110) / 3;

if ((dolphinsAverageScore1 > koalasAverageScore1) && dolphinsAverageScore1 >= 100) {
    console.log(`Dolphins are the winner, congratulations!`);
} else if ((koalasAverageScore1 > dolphinsAverageScore1) && koalasAverageScore1 >= 100) {
    console.log(`Kolas are the winner, congratulations!`);
} else if ((koalasAverageScore1 === dolphinsAverageScore1) && koalasAverageScore1 >= 100 && dolphinsAverageScore1 >= 100) {
